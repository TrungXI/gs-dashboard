...
const BOTS: {
  ...
  { calcVersion: 'TNK - CLB - Top Rung H1', label: 'TNK CLB · Rung H1 (≥55%)', side: 'tai' },
  { calcVersion: 'TNK - CLB - Top Rung H2', label: 'TNK CLB · Rung H2 (≥55%)', side: 'tai' },
  { calcVersion: 'TNK - CLB - Top Tài H2', label: 'TNK CLB · Tài H2 đầu hiệp (≥55%)', side: 'tai' },
  { calcVersion: 'TNK - CLB - Rung Except', label: 'TNK CLB · Rung Except', side: 'tai' },
  { calcVersion: 'TNK - CLB - Top Xỉu H1', label: 'TNK CLB · Xỉu H1 (≥55%)', side: 'xiu' },
  { calcVersion: 'TNK - CLB - Top Xỉu FT', label: 'TNK CLB · Xỉu FT (≥55%)', side: 'xiu' },
  { calcVersion: 'TNK - CLB - Goal Xỉu H1', label: 'TNK CLB · Goal Xỉu H1 (Σ≤1.1)', side: 'xiu' },
  { calcVersion: 'TNK - CLB - Goal Xỉu FT', label: 'TNK CLB · Goal Xỉu FT (≤2)', side: 'xiu' },
  { calcVersion: 'TNK - AS16 - Top Xỉu H1', label: 'TNK AS16 · Xỉu H1 (≥52%)', side: 'xiu' },
  { calcVersion: 'TNK - AS16 - Top Xỉu FT', label: 'TNK AS16 · Xỉu FT (≥52%)', side: 'xiu' },
