...
// GET /api/asians-analyst — read the current gs_asians_analyst table (rebuilt by POST
// /api/asians-analyst/sync). Giao hữu Châu Á 16p league only — mirror of /api/clbv-analyst
// for the 16p league instead of 20p_club.
...
export interface AsiansAnalystRow {
  teamId: number;
  teamName: string;
...
function rowToApi(r: RawRow): AsiansAnalystRow {
  return {
    teamId: r.team_id,
